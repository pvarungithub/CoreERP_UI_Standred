...
export class SalesorderComponent {
  ...
  displayedColumns: string[] = ['salesOrderNubmber', 'materialCode', 'qty',
    'rate', 'discount', 'total',
    'deliveryDate'
  ];
  branchCode: any;
  ...
  getSaleOrder() {
    const getSaleOrderUrl = String.Join('/', this.apiConfigService.getSaleOrder, this.branchCode.branchCode);
    this.apiService.apiPostRequest(getSaleOrderUrl, this.dateForm.value).subscribe(
      response => {
