...
export class VoucherTypesComponent  implements OnInit {
  ...
  constructor(
    ...
    this.modelFormData = this.formBuilder.group({
      voucherCode: [null, [Validators.required, Validators.minLength(1), Validators.maxLength(50)]],
      branch: [null],
      company: [null],
      ext1: [null],
      ext2: [null],
      ...
      prefix: [null],
      transaction: [null],
      voucherType: [null, [Validators.required, Validators.minLength(2), Validators.maxLength(50)]],
      active: [null],
      addDate: [null],
      voucherClass: [null],
      printText: [null]
