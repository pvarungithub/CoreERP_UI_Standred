...
import {
  ...
  AssignmentOfNumberSeriesToObjectTypesComponent, CommitmentItemComponent,
...
@NgModule({
  declarations: [
    ...
    CostingObjectNumberSeriesComponent, StandardRateComponent, FormulasComponent, CommitmentItemComponent, CostingObjectTypesComponent, DownTimeReasonComponent, DownTimeReasonComponent, CommitmentItemComponent, FormulasComponent, StandardRateComponent, CostingObjectNumberSeriesComponent, AssignmentOfNumberSeriesToObjectTypesComponent, CoastingActivitiesComponent, AssignmentOfNumberSeriesToObjectTypesComponent, CoastingActivitiesComponent, SecondaryCostElementsCreationComponent, SecondaryCostElementsCreationComponent, MaterialMasterComponent, MaterialMasterComponent, MaterialSizeComponent, MaterialSizeComponent, MaterialNumberAsssignmentComponent,
