...
import { 
  ...
  MaterialSizeComponent, MaterialMasterComponent, PrimaryCostElementsCreationComponent,
  SecondaryCostElementsCreationComponent, CoastingActivitiesComponent, CostingKeyFiguresComponent, AssignmentOfNumberSeriesToObjectTypesComponent, CostingObjectTypesComponent, CostingObjectNumberSeriesComponent,
...
@NgModule({
  declarations: [
    ...
    GoodsIssueNoteNumberSeriesComponent, BinsCreationComponent, PurchaseRequisitionNumberRangeComponent, PrimaryCostElementsCreationComponent, PrimaryCostElementsCreationComponent, CostingKeyFiguresComponent, CostingKeyFiguresComponent, CostingObjectTypesComponent,
    CostingObjectNumberSeriesComponent, CostingObjectTypesComponent, CostingObjectNumberSeriesComponent, AssignmentOfNumberSeriesToObjectTypesComponent, CoastingActivitiesComponent, AssignmentOfNumberSeriesToObjectTypesComponent, CoastingActivitiesComponent, SecondaryCostElementsCreationComponent, SecondaryCostElementsCreationComponent, MaterialMasterComponent, MaterialMasterComponent, MaterialSizeComponent, MaterialSizeComponent, MaterialNumberAsssignmentComponent,
